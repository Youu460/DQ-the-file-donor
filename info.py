...
BOT_TOKEN = environ['7768412623:AAH3UNMX5LeRhem4Aehd4hLiULs12yLMCRA']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002285178275').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', ' -1002231212148').split() if id_pattern.search(auth_channel)]
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://lisafiledata:lisafiledata@cluster0.hacp4.mongodb.net/")
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://botmaking867:botmaking867@cluster0.e5exz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
